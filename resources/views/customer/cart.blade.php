                ...
                @forelse($carts as $cart)
                    ...
                    <div class="cart-item position-relative">
                        ...
                        <div class="cart-action">
                            <button type="button" class="qty-btn minus-btn" data-id="{{ $cart->id }}">
                                −
                            </button>
                            <span class="qty-value" id="qty-{{ $cart->id }}">
                                {{ $cart->qty }}
                            </span>
                            <button type="button" class="qty-btn plus-btn" data-id="{{ $cart->id }}">
                                +
                            </button>
                        </div>
                        ...
                        <div class="ms-3">
                            <form action="{{ route('cart.destroy', $cart->id) }}" method="POST"
                                onsubmit="return confirm('Hapus {{ $cart->menu->name }} dari keranjang?')">
                                @csrf
                                @method('DELETE')
