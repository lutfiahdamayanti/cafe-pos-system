...
<div class="container-fluid">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($order->status == 'Ready')
                                        <span class="badge bg-secondary">Siap Disajikan</span>
    ...
    <div class="card shadow-sm border-0 mt-4">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-center">
                <div style="width:350px; height:350px;"><canvas id="paymentChart"></canvas></div>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow-sm border-0 mt-4">
        <div class="card-body">
            ...
            <table class="table table-striped">
                <thead><tr><th>Hari</th><th>Jumlah Pesanan</th></tr></thead>
                <tbody>
...
new Chart(paymentCtx,{
    ...
    data:{
        ...
        datasets:[{data:@json($paymentData)}]
    },
    options:{
        responsive:true,
